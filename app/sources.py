...
SOURCES: tuple[Source, ...] = (
    ...
    Source("x", "@_akhaliq", "Новости"),
    Source("x", "@TheRundownAI", "Новости"),
    Source("x", "@dair_ai", "Новости"),
    Source("x", "@askalphaxiv", "Новости"),
    Source("x", "@OpenAI", "Новости"),
    Source("x", "@AnthropicAI", "Новости"),
    Source("x", "@mreflow", "Новости"),
    Source("x", "@karpathy", "Технические"),
    Source("x", "@simonw", "Технические"),
    Source("x", "@TheAhmadOsman", "Технические"),
    Source("x", "@rasbt", "Технические"),
    Source("x", "@ylecun", "Технические"),
    Source("x", "@gdb", "Технические"),
    Source("x", "@amansanger", "Технические"),
    Source("x", "@OfficialLoganK", "Технические"),
    Source("x", "@DataChaz", "Технические"),
    Source("x", "@emollick", "Авторские"),
    Source("x", "@sama", "Авторские"),
    Source("x", "@demishassabis", "Авторские"),
    Source("x", "@AndrewYNg", "Авторские"),
    Source("x", "@AravindSrinivas", "Авторские"),
    Source("x", "@GaryMarcus", "Авторские"),
    Source("x", "@alliekmiller", "Авторские"),
    Source("x", "@kaifulee", "Авторские"),
    Source("x", "@clairesilver12", "Креативные"),
    Source("x", "@bilawalsidhu", "Креативные"),
    Source("x", "@LinusEkenstam", "Креативные"),
    Source("x", "@Pika_Labs", "Креативные"),
    Source("x", "@runwayml", "Креативные"),
)
